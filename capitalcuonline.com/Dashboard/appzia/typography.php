...
<h3>Deposit<small></small></h3><p class="text-muted m-b-30">all deposits on Capital Credit Union Online  can be done online as all accounts are electronic accounts(E-account). deposits can be made through bank transfers from any bank or directly from your credit cards.</p><p class="text-muted m-b-30">you can contact an account officer through our website for more directions.</p>
...
<?php
echo $name
?>,I am your account officer, I will guide you on how to run and enjoy our services mail me for more info on bobroberts@capitalcuonline.com

</p> <footer>Bob R. Roberts<cite title="Source Title">&nbspAccountant&nbspCapital Credit Union online</cite> </footer></blockquote><blockquote class="blockquote-reverse"><p></p> <footer><cite title="Source Title"></cite> </footer></blockquote></div></div></div></div></div></div></div><footer class="footer"> © 2018 Capital Credit Union - All Rights Reserved. </footer></div></div> <script src="assets/js/jquery.min.js"></script> <script src="assets/js/bootstrap.min.js"></script> <script src="assets/js/modernizr.min.js"></script> <script src="assets/js/detect.js"></script> <script src="assets/js/fastclick.js"></script> <script src="assets/js/jquery.slimscroll.js"></script> <script src="assets/js/jquery.blockUI.js"></script> <script src="assets/js/waves.js"></script> <script src="assets/js/wow.min.js"></script> <script src="assets/js/jquery.nicescroll.js"></script> <script src="assets/js/jquery.scrollTo.min.js"></script> <script src="assets/js/app.js"></script> </body>
<!-- Mirrored from themesdesign.in/appzia/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jan 2018 18:29:07 GMT -->
</html>