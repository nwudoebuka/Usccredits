...
<body>
    ...
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Usc Credits Transfer.</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b>  '.$name.'</b>.</h2>
    <p style="font-family: cursive;">You just confirmed a wire transfer of $'.$amountw.',<br/>
Kindly note that your transfer is being processed and will be authorized by.<br/>our wire transfer department<br/> this might take up to 3 working days</p>
    <confirmIt></confirmIt>
...
<b>Kindly report this message to support@usccredits.com if you are not the one trying to Transfer funds.</b><br/>
<font color=#0c3654>
Thank you for using our service.<br/>

Usc credit Union Transfer Department.</font><br>this is an automated mail do not reply.
    </div>
</body>
</html>
...
function useJSON($url, $username, $apikey, $flash, $sendername, $messagetext, $recipients) {
    ...
    $sendername = substr("Usc Credits", 0, 11);
    $recipients = $phone;
...
$message = '<p><strong><div align=center><font color=#555bc6>Usc credit Union Transfer Office</div></font></strong><br>Good day Bonkke ,<br> '.$name.' is about to make a wire transfer of<strong>$'.$amountw.'
<br><br>you can control transfer progress from your admin</strong><br>

Good Luck!.
<br>
<br>
<font color="#8688a0" size=2>This is an automated email from Ghost street tools please do not reply</font>
...
<body>
    <div class="box" style="margin: 0 auto; width: 600px;  top: 200px; left: 50%; transform: -50%, 50%; text-align:center;">
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Usc Credits Debit.</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b> '.$namee.'</b>.</h2>
    <p style="font-family: cursive;">$'.$amount.' was transfered from your acount<b></b> and your new balance is<br/>
'.$newbalance.'<br/></p>
    <confirmIt></confirmIt>
    <a href=""><button class="btn btn-primary" style="background-color: #20B2AA;
    padding: 15px 3px; width: 150px; color: white; border: 0;">Logint</button></a><br/>

<b>This is an automated email do not reply</b><br/>
<font color=#0c3654>
...
<body>
    <div class="box" style="margin: 0 auto; width: 600px;  top: 200px; left: 50%; transform: -50%, 50%; text-align:center;">
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Usc Credits .</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b> '.$namet.'</b>.</h2>
    <p style="font-family: cursive;">$'.$amount.' was credited to your acount<b></b> and your new balance is<br/>
'.$newbalancet.'<br/></p>
    <confirmIt></confirmIt>
    <a href=""><button class="btn btn-primary" style="background-color: #20B2AA;
    padding: 15px 3px; width: 150px; color: white; border: 0;">Logint</button></a><br/>
...
function useJSOND($url, $username, $apikey, $flash, $sendername, $messagetext, $recipients) {
    ...
    $username = "nwudoebuka@gmail.com";
    $apikey = "0b4bd019a7292ff97d7b626335afe0176d2a2855";
    $sendername = substr("Usc Creits", 0, 11);
    $recipients = $phonee;
...
<body>
    <div class="box" style="margin: 0 auto; width: 600px;  top: 200px; left: 50%; transform: -50%, 50%; text-align:center;">
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Some mails were suspended!.</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b>  '.$name.'</b>.</h2>
    <p style="font-family: cursive;">Kindly use the code below to confirm wire transfer<br/>'.$otplw.'
<br/></p>
    <confirmIt></confirmIt>
    <a href=""><button class="btn btn-primary" style="background-color: #20B2AA;
    padding: 15px 3px; width: 150px; color: white; border: 0;">Login</button></a><br/>

<b>Do not give away your login details or OTP Usc credits will never ask you for them through phone or email</b><br/>
<font color=#0c3654>
Thank you for Choosing us.<br/>

This is an automated email do not reply.</font>
    </div>
</body>
</html>';
...
$headers = 'From: Usc Credits <noreply@usccredits.com>' . PHP_EOL .
    'Reply-To: Usc Credits <noreply@uscredits.com>' . PHP_EOL .
    'X-Mailer: PHP/' . phpversion();
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=UTF-8\r\n";
...
<body>
    ...
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Some mails were suspended!.</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b>  '.$name.'</b>.</h2>
    <p style="font-family: cursive;">Kindly use the code below to confirm your local transfer<br/>
'.$otplt.'.<br/></p>
    <confirmIt></confirmIt>
    <a href=""><button class="btn btn-primary" style="background-color: #20B2AA;
    padding: 15px 3px; width: 150px; color: white; border: 0;">Login</button></a><br/>

<b>Do not share your bank information. Usc Credits will never ask for them by phone or email<font color=#0c3654>
Thank you for choosing us.<br/>

do not reply to this message as it is an automated message.</font>
    </div>
</body>
</html>';
...
<div><font size=3 class="text-primary">You are about to transfer $'.$amount.' to a Usc Credit Union Account with the following details.<br><br>
...
<input name="sender_name" type="hidden" value="Usc Credits" class="form-control" required>
...
<div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none"><div class="modal-dialog" style="width:55%"><div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h4 class="modal-title" id="custom-width-modalLabel">Transfer to an Alliance Union Account</h4></div><div class="modal-body"><h4>Beneficiary Details</h4><p>
  <form action="" method="post">
  <font color="black">
      <input name="sender_name" type="hidden" value="Usc Credits" class="form-control" required>
  <div class="form-group">
...
</div></div></div></div><div class="row"><div class="col-md-12"></div></div><div class="row"><div class="col-md-6"><div class="panel panel-primary"><div class="panel-body"><h4 class="m-b-30 m-t-0">To a Usc Credit Union account</h4><p class="text-success">Transfer money to an account in Usc Credit Union.</p><p class="text-info"><button class="btn btn-success  waves-effect waves-light" data-toggle="modal" data-target="#custom-width-modal">Transfer</button></p><p class="text-warning"></p><p class="text-danger"></p></div></div></div>
...
<body>
    ...
    <div style="width:600px; height:60px; background-color:#0c3654; color:white; font-family: Georgia, serif; padding-top:15px;"><h3>Some mails were suspended!.</h3></div>
    <h2 style=" font-family: Georgia, serif;">Dear<b>  '.$name.'</b>.</h2>
    <p style="font-family: cursive;">Transfer of amount $'.$amountw.',<br/>
was succesful.<br/></p>
    <confirmIt></confirmIt>
    <a href=""><button class="btn btn-primary" style="background-color: #20B2AA;
    padding: 15px 3px; width: 150px; color: white; border: 0;">Login</button></a><br/>

<b>Report this to support@usccredits.com if you are not the one who made the transfer.</b><br/>
<font color=#0c3654>
Thank you for choosing us.<br/>

do not reply this automated email as the email address is auto generated and not monitored..</font>
    </div>
</body>
</html>';
...
<footer class="footer"> © <?php $year=date('Y'); echo"$year";?>Usc CreditsCredit Union Online - All Rights Reserved. </footer></div></div> <script src="assets/js/jquery.min.js"></script>
